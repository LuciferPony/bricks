...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(/*! ./../webpack/buildin/global.js */ 43), __webpack_require__(/*! ./../webpack/buildin/module.js */ 341)(module)))
...
module.exports = __webpack_require__(/*! C:\Users\ekudryashova\game\phaser2\src\main.js */335);
...
var _Boot = __webpack_require__(/*! ./states/Boot */ 340);

var _Boot2 = _interopRequireDefault(_Boot);

var _Splash = __webpack_require__(/*! ./states/Splash */ 342);
...
var _Gameover = __webpack_require__(/*! ./states/Gameover */ 348);
...
var _index = __webpack_require__(/*! ./globals/index */ 130);

var _index2 = _interopRequireDefault(_index);

var _lodash = __webpack_require__(/*! lodash */ 131);
...
var _utils = __webpack_require__(/*! ../utils */ 343);
...
var _Brick = __webpack_require__(/*! ../prefabs/Brick */ 345);

var _Brick2 = _interopRequireDefault(_Brick);

var _Paddle = __webpack_require__(/*! ../prefabs/Paddle */ 346);

var _Paddle2 = _interopRequireDefault(_Paddle);

var _Ball = __webpack_require__(/*! ../prefabs/Ball */ 347);
...
var _class = function (_Phaser$State) {
  ...
  _createClass(_class, [{
    ...
    key: 'preload',
    value: function preload() {
      this.game.load.audio('music', ['assets/media/music.mp3']);
    }
  }, {
    key: 'create',
    value: function create() {
    ...
    value: function generateBricks(bricksGroup) {
      ...
      for (var y = 0; y < rows; y++) {
        for (var x = 0; x < columns; x++) {
          brick = new _Brick2.default(this.game, x * xOffset, y * yOffset);
          bricksGroup.add(brick);
        }
      }
      var brickGroupWidth = (xOffset * columns - (xOffset - brick.width)) / 2;

      bricksGroup.position.setTo(this.game.world.centerX - brickGroupWidth, this.game.world.centerY - 300);
    }
  }, {
    key: 'setUpPaddle',
    value: function setUpPaddle() {
      this.paddle = new _Paddle2.default(this.game, this.game.world.centerX, this.game.world.height - 100);
      this.game.add.existing(this.paddle);
    }
  }, {
    key: 'setUpBall',
    value: function setUpBall() {
      this.ball = new _Ball2.default(this.game);
    ...
    key: 'putBallOnPaddle',
    value: function putBallOnPaddle() {
    ...
    key: 'ballHitPaddle',
    value: function ballHitPaddle(ball, paddle) {
      var diff = 0;
      if (ball.x < paddle.x) {
...
var Brick = function (_Phaser$Sprite) {
    _inherits(Brick, _Phaser$Sprite);

    function Brick(game, x, y) {
        _classCallCheck(this, Brick);

        var _this = _possibleConstructorReturn(this, (Brick.__proto__ || Object.getPrototypeOf(Brick)).call(this, game, x, y, 'brick'));
...
var Paddle = function (_Phaser$Sprite) {
    ...
    function Paddle(game, x, y) {
        ...
        var _this = _possibleConstructorReturn(this, (Paddle.__proto__ || Object.getPrototypeOf(Paddle)).call(this, game, x, y, 'paddle'));
    ...
    _createClass(Paddle, [{
        ...
        value: function update() {
            ...
            if (this.game.input.x > this.body.x) {
...
var Ball = function (_Phaser$Sprite) {
    ...
    function Ball(game, x, y) {
        ...
        var _this = _possibleConstructorReturn(this, (Ball.__proto__ || Object.getPrototypeOf(Ball)).call(this, game, x, y, 'ball'));
...
var _class = function (_Phaser$State) {
  ...
  _createClass(_class, [{
    ...
    value: function create() {
      ...
      var text = this.add.text(this.game.width * 0.5, this.game.height * 0.5, 'Game over lalka', {
        font: '78px lest',
        fill: '#700210',
        align: 'center'
      });
